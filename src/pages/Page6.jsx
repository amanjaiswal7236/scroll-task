...
const Page6 = () => {
    return (
        <div className="flex flex-col lg:flex-row h-screen w-full">
            {/* Left Section */}
            <div className="relative bg-green-800 text-white flex flex-col justify-center items-center p-8 h-full w-full lg:w-[45%]">
                <div className="relative flex flex-col justify-center items-center mt-16 md:mt-32">
                    {/* Scroll Indicator */}
                    <div className="absolute top-1/4 left-96 transform -translate-x-10 -translate-y-1/3 bg-green-800 rounded-full h-72 w-72 md:h-80 md:w-80">
                    ...
                    >
                        <p className="text-xl md:text-xl mt-2 text-left">Best Classifieds</p>
                        <motion.h1
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        <p className="text-xl md:text-xl mt-2 text-right">Countries</p>
                    </motion.div>
                </div>
                {/* Company Info */}
                ...
                <div className="relative w-full mt-auto mb-8">
                    <a href="/case-study" className="absolute left-0 text-lg md:text-xl font-extralight">Coming Soon</a>
                    <button className="absolute right-0 text-lg md:text-xl">Skip</button>
                </div>
            </div>
            {/* Right Section */}
            <div className="bg-green-600 flex justify-center items-center p-8 h-full w-full lg:w-[55%]">
                <motion.img
