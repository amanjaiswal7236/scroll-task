        ...
        <div className="flex flex-col lg:flex-row h-screen w-full">
            ...
            <div className="relative bg-blue-800 text-white flex flex-col justify-center items-center p-8 h-full w-full lg:w-[45%]">
                <div className="relative flex flex-col justify-center items-center mt-16 md:mt-32 ">
                    ...
                    >
                        <p className="text-xl md:text-xl mt-2 text-left">Text Headline</p>
                        <motion.h1
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        <p className="text-xl md:text-xl mt-2 text-right">Footer Headline</p>
                    </motion.div>
                </div>
            ...
            {/* Right Section */}
            <div className="bg-blue-400 flex justify-center items-center p-8 h-full w-full lg:w-[55%]">
                <motion.img
