...
const Page3 = () => {
    return (
        <div className="flex flex-col lg:flex-row h-screen w-full">
            {/* Left Section */}
            <div className="relative bg-blue-950 text-white flex flex-col justify-center items-center p-8 h-full w-full lg:w-[45%]">
                <div className="relative flex flex-col justify-center items-center mt-16 md:mt-32 ">
                    {/* Scroll Indicator */}
                    <div className="absolute top-1/4 left-96 transform -translate-x-10 -translate-y-1/3 bg-blue-950 rounded-full h-72 w-72 md:h-80 md:w-80">
                    ...
                    >
                        <p className="text-xl md:text-xl mt-2 text-left">Powered by advance</p>
                        <motion.h1 
                            initial={{ opacity: 0 }} 
                            animate={{ opacity: 1 }}
                        ...
                        <p className="text-xl md:text-xl mt-2 text-right">algorithms</p>
                    </motion.div>
                </div>
                {/* Company Info */}
                <div className="text-center lg:text-left z-10 mt-8">
                    <p className="text-4xl md:text-4xl font-bold">ABC 345</p>
            ...
            {/* Right Section */}
            <div className="bg-blue-900 flex justify-center items-center p-8 h-full w-full lg:w-[55%]">
                <motion.img
